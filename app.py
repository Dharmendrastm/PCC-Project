...
# Add "By Dharmendra InCode" label at the bottom-right corner
label_signature = tk.Label(root, text="By:- Dharmendra InCode", font=("Helvetica", 12, "bold"), bg="#212121", fg="green")
